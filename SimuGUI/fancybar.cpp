...
void FancyBarPrivate::createWindowButtons()
{
	...
	//by jh
    m_logoButton->setIcon(QIcon("./Icon/main/logo"));
	...
	//by jh
    m_minimizeButton->setIcon(QIcon("./Icon/main/min"));
...
//    m_minimizeButton->setIconSize(QSize(22,22));
	...
	//by jh
    m_maximizeButton->setIcon(QIcon("./Icon/main/max"));
...
//    m_maximizeButton->setIconSize(QSize(22,22));
	...
	//by jh
    m_closeButton->setIcon(QIcon("./Icon/main/close"));
	...
	//bj jh
    m_maximizeAction = new QAction(QIcon("./Icon/main/max2"), tr("maximize"), this);

	//bj jh
    m_minimizeAction = new QAction(QIcon("./Icon/main/min2"), tr("minimize"), this);

	//bj jh
    m_restoreAction = new QAction(QIcon("./Icon/main/restore2"), tr("restore"), this);

	//bj jh
    m_closeAction = new QAction(QIcon("./Icon/main/close2"), tr("close"), this);
...
void FancyBarPrivate::windowStateChange(QObject *obj)
{
    ...
    if(m_isMaximized){
		...
		//by jh
        m_maximizeButton->setIcon(QIcon("./Icon/main/restore"));
    }else{
